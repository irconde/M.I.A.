        ...
        if (this.props.isUpload === true && this.props.isDownload === true) {
            return (
                <div style={this.state.barStyle}>
                    <svg width="2rem" height="2rem" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                        <title>ic_file_queue</title>
                        <g id="ic_file_queue" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g id="recent_actors-1.5rem" transform="translate(1.000000, 0.000000)">
