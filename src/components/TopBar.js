    ...
    constructor(props){
        ...
        this.state = {
            barStyle: {
                ...
                color: 'white',
                boxShadow: '0rem 2rem 8rem 2rem rgba(0, 0, 0, 0.5)'
            },
            imgStyle: {
                margin: '0.5rem'
            },
